				...
				<tbody>
                    <?php foreach ($fakultas as $key => $value): ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning btn-sm" href="<?php echo base_url('fakultas/ubah/'.$value['fakultas_id']) ?>"><i class="bi bi-pencil-square"></i> Edit</a>
								<a class="btn btn-danger btn-sm btn-hapus" href="<?php echo base_url('fakultas/hapus/'.$value['fakultas_id']) ?>"><i class="bi bi-trash"></i> Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
				</tbody>
