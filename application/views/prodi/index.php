				...
				<tbody>
                    <?php foreach ($prodi as $key => $value): ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning btn-sm" href="<?php echo base_url('prodi/ubah/'.$value['prodi_id']) ?>"><i class="bi bi-pencil-square"></i> Edit</a>
								<a class="btn btn-danger btn-sm btn-hapus" href="<?php echo base_url('prodi/hapus/'.$value['prodi_id']) ?>"><i class="bi bi-trash"></i> Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
				</tbody>
